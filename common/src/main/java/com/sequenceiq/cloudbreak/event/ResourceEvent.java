...
public enum ResourceEvent {
    ...
    STACK_VERTICALSCALING("cluster.changing.credential"),
    STACK_VERTICALSCALED("cluster.changed.credential"),
    STACK_VERTICALSCALED_FAILED("cluster.changed.credential"),
