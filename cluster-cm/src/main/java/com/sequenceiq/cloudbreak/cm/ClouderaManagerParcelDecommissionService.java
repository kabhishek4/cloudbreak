...
class ClouderaManagerParcelDecommissionService {
    ...
    public void removeUnusedParcelVersions(ApiClient apiClient, ParcelsResourceApi parcelsResourceApi, ParcelResourceApi parcelResourceApi,
            StackDtoDelegate stack, ClouderaManagerProduct product) throws ApiException {
    ...
    private Multimap<String, String> getParcelVersionsByStatusNameAndVersion(ParcelsResourceApi parcelsResourceApi, StackDtoDelegate stack,
            ClouderaManagerProduct product, ParcelStatus parcelStatus) throws ApiException {
    ...
    private ParcelOperationStatus undistributeParcels(ApiClient apiClient, ParcelResourceApi parcelResourceApi, StackDtoDelegate stack, Multimap<String,
            String> parcels) {
    ...
    private ParcelOperationStatus removeParcels(ApiClient apiClient, ParcelResourceApi parcelResourceApi, StackDtoDelegate stack, Multimap<String,
            String> parcels) {
