...
public class ModelDescriptions {
    ...
    public static class RecipeModelDescription {
        ...
        public static final String TYPE = "type of recipe [PRE_SERVICE_DEPLOYMENT,PRE_TERMINATION,POST_CLOUDERA_MANAGER_START,POST_SERVICE_DEPLOYMENT]. "
                + "The default is PRE_SERVICE_DEPLOYMENT";
        public static final String WORKSPACE_ID = "id of the workspace";
