...
public class DistroXV1Controller implements DistroXV1Endpoint {
    ...
    public FlowIdentifier putVerticalScalingByName(@ResourceName String name, @Valid DistroXVerticalScaleV1Request updateRequest) {
        ...
        return stackOperations.putVerticalScaling(NameOrCrn.ofName(name), getWorkspaceIdForCurrentUser(), stackVerticalScaleV4Request);
    }
    ...
    public FlowIdentifier putVerticalScalingByCrn(@ValidCrn(resource = CrnResourceDescriptor.DATAHUB) @TenantAwareParam @ResourceCrn String crn,
        ...
        return stackOperations.putVerticalScaling(NameOrCrn.ofCrn(crn), getWorkspaceIdForCurrentUser(), stackVerticalScaleV4Request);
    }
