...
public class StackV4Controller extends NotificationController implements StackV4Endpoint {
    ...
    @Override
    @InternalOnly
    public RdsUpgradeV4Response upgradeRdsByClusterNameInternal(Long workspaceId, String clusterName, TargetMajorVersion targetMajorVersion, String initiatorUserCrn) {
