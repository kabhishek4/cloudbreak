...
import static com.sequenceiq.cloudbreak.core.flow2.cluster.stopstartus.StopStartUpscaleEvent.STOPSTART_UPSCALE_GET_STARTED_INSTANCES_EVENT;
...
import static com.sequenceiq.cloudbreak.core.flow2.cluster.stopstartus.StopStartUpscaleState.STOPSTART_UPSCALE_GET_STARTED_INSTANCES_STATE;
...
public class StopStartUpscaleFlowConfig extends StackStatusFinalizerAbstractFlowConfig<StopStartUpscaleState, StopStartUpscaleEvent> {
    ...
    private static final List<Transition<StopStartUpscaleState, StopStartUpscaleEvent>> TRANSITIONS =
            ...
            .from(INIT_STATE)
                    .to(STOPSTART_UPSCALE_GET_STARTED_INSTANCES_STATE)
                    .event(STOPSTART_UPSCALE_TRIGGER_EVENT)
                    .defaultFailureEvent()
            .from(STOPSTART_UPSCALE_GET_STARTED_INSTANCES_STATE)
                    .to(STOPSTART_UPSCALE_START_INSTANCE_STATE)
                    .event(STOPSTART_UPSCALE_GET_STARTED_INSTANCES_EVENT)
                    .defaultFailureEvent()
