...
import static com.sequenceiq.cloudbreak.core.flow2.cluster.stopstartds.StopStartDownscaleEvent.STOPSTART_DOWNSCALE_GET_RUNNING_INSTANCES_EVENT;
...
import static com.sequenceiq.cloudbreak.core.flow2.cluster.stopstartds.StopStartDownscaleState.STOPSTART_DOWNSCALE_GET_RUNNING_INSTANCES_STATE;
...
public class StopStartDownscaleFlowConfig extends StackStatusFinalizerAbstractFlowConfig<StopStartDownscaleState, StopStartDownscaleEvent> {
    ...
    private static final List<Transition<StopStartDownscaleState, StopStartDownscaleEvent>> TRANSITIONS =
            ...
            .from(StopStartDownscaleState.INIT_STATE)
                .to(STOPSTART_DOWNSCALE_GET_RUNNING_INSTANCES_STATE)
                .event(STOPSTART_DOWNSCALE_TRIGGER_EVENT)
                .defaultFailureEvent()
            .from(STOPSTART_DOWNSCALE_GET_RUNNING_INSTANCES_STATE)
                .to(STOPSTART_DOWNSCALE_HOSTS_DECOMMISSION_STATE)
                .event(STOPSTART_DOWNSCALE_GET_RUNNING_INSTANCES_EVENT)
                .defaultFailureEvent()
