...
public abstract class AbstractRdsConfigProvider {
     ...
     */
    private RDSConfig createNewRdsConfig(StackView stack, ClusterView cluster, String databaseHost, String databaseHost, String dbName, String dbUserName, String dbPort) {
